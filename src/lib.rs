...
#[derive(Debug)]
pub struct LynxShardProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LynxShardProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LynxShard processing");
    
    let mut processor = LynxShardProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LynxShardProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LynxShardProcessor::new(false);
